...
class ArticleDetailView(DetailView):
    """
    C:\Users\fubon\AppData\Local\GitHubDesktop\app-1.1.0\resources\app\git\cmd
    C:\Users\fubon\AppData\Local\GitHubDesktop\app-1.1.0\resources\app\git\mingw64\bin
    显示文章详情
    """
    model = Article
